    ...
    >
      <View style={styles.formContainer}>
        <Text style={styles.subTitle}>
          Hi {params?.customer_details?.name},
        </Text>
        <Text style={[styles.subTitle, { marginTop: 5 }]}>
          We noticed that your email ({params?.customer_details?.email}) is not
          verified with Drift. Please take a moment to verify your account
        </Text>
